...
AThe_West_Coast_HorrorHUD::AThe_West_Coast_HorrorHUD(const class FPostConstructInitializeProperties& PCIP) : Super(PCIP)
{
...
void AThe_West_Coast_HorrorHUD::DrawHUD()
{
	Super::DrawHUD();
